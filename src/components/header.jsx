...
export default function Header() {
    const Adv = () => {
        return(
            <p className="text-[white] md:text-[1.6vw]  xs:text-[2vw] mxx:text-[35px]">
      ...
      return(
        <div className="w-full h-full md:flex-row  flex xs:text-[2vh] xs:flex-col justify-around items-center">
          <ul className="w-[30%] xs:w-full xs:justify-around md:w-[35%] min-[600px]:h-[30%] h-full justify-between items-center flex flex-row">
            <li><a href="/" className="md:text-[1.5vh] min-[600px]:text-[2.7vw] xs:text-[3.5vw] lg:text-[2vh] mxx:text-[1.7vw] mxx:text-[27px]">Home</a></li>
            <li><a href="/listofproducts" className="md:text-[1.5vh] min-[600px]:text-[2.7vw] xs:text-[3.5vw] lg:text-[2vh] mxx:text-[1.7vw] mxx:text-[27px]">Collection</a></li>
            <li><a href="/listofproducts" className="md:text-[1.5vh] min-[600px]:text-[2.7vw] xs:text-[3.5vw] lg:text-[2vh] mxx:text-[1.7vw] mxx:text-[27px]">Shop</a></li>
            <li><a href="/blog" className="md:text-[1.5vh] min-[600px]:text-[2.7vw] xs:text-[3.5vw] lg:text-[2vh] mxx:text-[1.7vw] mxx:text-[27px]">Blog</a></li>
            <li><a href="/contactUs" className="md:text-[1.5vh] min-[600px]:text-[2.7vw] xs:text-[3.5vw] lg:text-[2vh] mxx:text-[1.7vw] mxx:text-[27px]">Contact Us</a></li>
          </ul>
          ...
          <div className="lg:h-full w-[20%] min-[600px]:h-[40%] xs:w-full md:w-[35%] lg:w-[25%] h-full flex flex-row justify-between items-center">
            ...
            <a href="/storelocation" className="bg-[#0e343d] text-center lg:text-[1.7vh] align-center w-[60%] h-[80%] center flex justify-center items-center text-[#ffffff] min-[600px]:text-[2.7vw] xs:text-[3vw] md:text-[1.7vw] mxx:text-[1.4vw] mxx:text-[27px]">Get Special Offers</a>
            </div>
    ...
    const Options = () => {
      ...
      // CODE
        return(
          ...
          <h3 className="text-[white] xs:text-[3vw] md:text-[2vw] mxx:text-[27px]">EN</h3>
          ...
          <div ref={disapper} style={{display:"none"}} className="bg-[red] h-[10%] w-[10%] absolute flex flex-col justify-center items-center mr-[0%] mt-[9%]">
            <a className="w-full md:text-[2vw] text-center flex justify-center items-center h-1/2 bg-[white] cursor-pointer hover:bg-[#282c34] xs:text-[3vw] mxx:text-[27px]">RU</a>
            <a className="w-full md:text-[2vw] text-center flex justify-center items-center h-1/2 bg-[white] cursor-pointer hover:bg-[#282c34] xs:text-[3vw] mxx:text-[27px]">EU</a>
          </div>
        </div>
        )
    }
